...
//	public static String[] to ={"seleniumcoaching@gmail.com","trainer@way2automation.com"};
	public static String from = "pariindiana88@gmail.com";
	public static String password = "ilovemyindia8891";
	public static String[] to ={"sparihar08@yahoo.com","pari_indiana88@yahoo.com"};
	public static String subject = "Extent Project Report";
	
	public static String messageBody ="TestMessage";
	public static String attachmentPath="/Users/Parihar08/Desktop/Mom_Dad.jpeg";
